    ...
    JILI: {
        ...
        icon: (isSelected) => (
            ...
            >
                ...
                <use href="#icon-JILI" fill={isSelected ? "#05012b" : "#B3BEC1"} />
            </svg>
        )
    },
    CQ9: {
    ...
    PG: {
        ...
        icon: (isSelected) => (
            ...
            >
                ...
                <use href="#icon-PG" fill={isSelected ? "#05012b" : "#B3BEC1"} />
            </svg>
        )
    },
    EVO_Electronic: {
        ...
        icon: (isSelected) => (
            ...
            >
                ...
                {/* Reference the symbol here */}
                <use href="#icon-EVO_Electronic" fill={isSelected ? "#05012b" : "#B3BEC1"} />
            </svg>
        )
    },
